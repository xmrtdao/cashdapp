...
exports.isProfileAssociatedGerm = isProfileAssociatedGerm;
exports.validateProfileAssociatedGerm = validateProfileAssociatedGerm;
...
exports.isLiveEventPreferences = isLiveEventPreferences;
exports.validateLiveEventPreferences = validateLiveEventPreferences;
...
function isProfileAssociatedGerm(v) {
    return is$typed(v, id, hashProfileAssociatedGerm);
}
function validateProfileAssociatedGerm(v) {
...
function isLiveEventPreferences(v) {
    return is$typed(v, id, hashLiveEventPreferences);
}
function validateLiveEventPreferences(v) {
